      ...
      <Box sx={{ 
        ...
        <Fade in={true} timeout={800}>
          <Paper elevation={3} sx={{
            ...
            <Typography variant="body1" align="center">Select a conversation to start chatting</Typography>
          </Paper>
        </Fade>
      </Box>
    );
             ...
             <Grow in={true} key={index} timeout={(index + 1) * 200}>
               <Box sx={{ 
                 ...
                 <Paper sx={{ 
                   ...
                   backgroundColor: index % 2 === 0 ? 'rgba(255, 255, 255, 0.9)' : 'rgba(3, 169, 244, 0.15)'
                 }}>
